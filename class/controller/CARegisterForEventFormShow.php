...
class CARegisterForEventFormShow extends CAjaxInit
{
	//*********************************************************************************
	//*********************************************************************************
	...
	//*********************************************************************************
 	...
 	private function init()
 	{
	    ...
	    $data =
	    [
		    "modalHtml" => $objStaticHtml->replaceInString($this->objSTemplate->getHtml("form", "registerForEventForm", $data)),
	    ];
	...
	private function setInputVars()
	{
		...
		{
			$this->objSOutput->critical("Event does not exist [".$this->objValidation->vars["articleId"]."]");
		}
		...
		{
			$this->objSOutput->critical("Event does not exist");
		}
